...
const val DEFAULT_CLEANUP_PROMPT =
    "Edit ORIGINAL TEXT using only the SPOKEN EDIT INSTRUCTION. Original text is source material, " +
        ...
        "quotes, or Markdown fences. Short commands are valid: 'K�rzer' means shorten, 'freundlicher' " +
        "means make friendlier, and 'aufr�umen' means remove dictation artifacts and fix grammar and " +
...
data class RecordingState(
     ...
     * [WAVEFORM_SAMPLES].
     *
     * Both capture paths — the foreground recorder and the keyboard's live
     * stream — reach this several times a second for the whole of a recording,
